...
**Export PNG** downloads (and **Copy** puts on the clipboard) the current chart (WebGL frame plus labels) as a PNG at the screen's device pixel ratio, named after the active axes.
